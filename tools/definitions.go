...
var AllTools = []ToolSpec{
	...
	// ==========================================================================
	{
		...
		Category:    "search",
		Country:     "finland",
		Description: `Search Finnish companies by name. Returns max 20 results per page (use size param to adjust, max 100). Filter by location, company_form (OY/OYJ/Ky). Common names like "Nokia" return 900+ results - use filters to narrow.`,
		ReadOnly:    true,
		Idempotent:  true,
		OpenWorld:   true,
	},
