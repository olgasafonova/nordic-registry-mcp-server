...
var AllTools = []ToolSpec{
	...
	// ==========================================================================
	{
		...
		Category: "search",
		Country:  "denmark",
		Description: `Search Danish companies by name. Returns single best match (CVR API limitation). If you have an 8-digit CVR number, use denmark_get_company instead.`,
		ReadOnly:   true,
		Idempotent: true,
		OpenWorld:  true,
	},
	...
	},
	{
		...
		Category: "subunits",
		Country:  "denmark",
		Description: `Get production units (P-numbers) for a Danish company by CVR. Returns locations with employee counts and industry info.`,
		ReadOnly:   true,
		Idempotent: true,
		OpenWorld:  true,
	},
	...
	// ==========================================================================
	{
		...
		Category: "search",
		Country:  "finland",
		Description: `Search Finnish companies by name. Filter by location, company_form (OY/OYJ/Ky). If you have a business ID (Y-tunnus), use finland_get_company.`,
		ReadOnly:   true,
		Idempotent: true,
		OpenWorld:  true,
	},
	...
	// ==========================================================================
	{
		...
		Category: "read",
		Country:  "sweden",
		Description: `Get company by 10-digit org number. Requires BOLAGSVERKET_CLIENT_ID/SECRET env vars. No name search available - must have org number.`,
		ReadOnly:   true,
		Idempotent: true,
		OpenWorld:  true,
	},
